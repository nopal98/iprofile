...
class Profile extends CI_Controller {
    ...
    public function qr_code()
    {
        ...
        $data['main_content'] = $this->load->view('admin/user/qr_code', $data, TRUE);
        $this->load->view('admin/index', $data);
    }
    ...
    public function update_fonts(){
        ...
        if ($_POST) {
            ...
            $data = array(
                ...
                'gd_color1' => $this->input->post('gd_color1', true),
                'gd_color2' => $this->input->post('gd_color2', true)
            );
    ...
    public function update(){
        ...
        if ($_POST) {
            ...
            if(!empty($this->input->post('enable_vcard'))){ $enable_vcard = 1;}else{$enable_vcard = 0;}
            ...
            $data = array(
                ...
                'envato' => $this->input->post('envato', true),
                'upwork' => $this->input->post('upwork', true),
                'fiverr' => $this->input->post('fiverr', true),
                'freelancer' => $this->input->post('freelancer', true),
