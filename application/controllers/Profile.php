...
class Profile extends Home_Controller {
    ...
    {   
        ...
        if ($data['user']->enable_vcard == 0) {
            redirect(base_url('profile/account/'.$slug));
        }
    ...
    {   
        ...
        $data['post_title'] = $data['post']->title;
    ...
    public function account($slug)
    {
        ...
        if ($data['user']->enable_vcard == 1) {
            redirect(base_url($slug));
        }

        $data['page_title'] = "Account";
        $data['description'] = "Account notice";
        $data['keywords'] = "Account notice";
        $this->load->view('account_notice');
    }
