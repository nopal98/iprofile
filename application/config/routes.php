...
if ($uri == 'verify' || $uri == 'terms-and-conditions' || $uri == 'blogs' || $uri == 'contact' || $uri == 'pricing' || $uri == 'users' || $uri == 'pay' || $uri == 'login' || $uri == 'register_user' || $uri == 'setup' || $uri == 'create-profile' || $uri == 'send-message' || $uri == 'upload_cv' || $uri == 'upload-file' || $uri == 'change_password' || $uri == 'faqs') {
