              ...
              <div class="active tab-pane" id="content1">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                      ...
                      <div class="form-group mb-40 mr-30">
                        <label class="mt-5">Enable Country</label>

                        <span class="pull-right"><input type="checkbox" name="enable_country" value="1" <?php if(settings()->enable_country == 1){echo 'checked';} ?> data-toggle="toggle" data-onstyle="info" data-width="100"></span>
                      </div>
