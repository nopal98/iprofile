    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="d-flex flex-row">
                        ...
                        <div class="m-l-10 align-self-center">
                            <h2 class="m-b-0"><?php echo $puser; ?></h2>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-row">
                        ...
                        <div class="m-l-10 align-self-center">
                            <h2 class="m-b-0"><?php echo count_users_by_status('verified'); ?></h2>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-row">
                        <div class="round align-self-center bg-info"><i class="fa fa-file-text-o"></i></div>
                        <div class="m-l-10 align-self-center">
                            <h2 class="m-b-0"><?php echo count_blogs(); ?></h2>
                            <h5 class="text-muted m-b-0">Blog Posts</h5></div>
                    </div>
                </div>
            </div>
        </div>
