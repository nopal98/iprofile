                      ...
                      <?php if (check_my_payment_status() == TRUE || $settings->enable_paypal == 0): ?>
                        <div class="col-sm-5">
                            ...
                            <div class="form-group mb-10 mr-30 mt-10 pb-10 bb1">
                                ...
                                <span class="pull-right"><input type="checkbox" name="enable_vcard" value="1" <?php if($user->enable_vcard == 1){echo 'checked';} ?> data-toggle="toggle" data-onstyle="info" data-width="100"></span>
                            </div>
