          ...
          <table class="table table-hover <?php if(count($users) > 10){echo "datatable";} ?>" id="dg_table">
            ...
            <tbody>
              ...
              <tr id="row_<?php echo $user->id; ?>">
                ...
                <?php else: ?>
                    <td><span class="label label-success"><i class="fa fa-check-circle"></i> <?php if(isset($user->payment->status)){echo $user->payment->status;} ?></span></td>
                <?php endif ?>
                
                <td>
                  <?php if ($user->status == 1): ?>
                    <span class="label label-info"><i class="fa fa-check-circle"></i> Active</span>
                  <?php else: ?>
                ...
                <td>
                  <i class="fa fa-clock-o"></i> <?php echo get_time_ago($user->created_at) ?>
                </td>
                <td>
                  <span class="label label-default text-danger"><b><?php echo date_dif(date('Y-m-d'), $user->payment->expire_on) ?></b> days left</span>
                </td>
