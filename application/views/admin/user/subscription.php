      ...
      <div class="col-xl-3 col-lg-3">
        ...
        <div class="box mt-50">
          ...
          <div class="box-body box-profile">
            ...
            <p>Subscription: <strong><?php echo html_escape($user->package) ?> Plan</strong></p>
            <p>Price: <strong><?php echo html_escape($settings->currency_symbol) ?><?php echo html_escape($user->amount) ?> </strong></p>
            ...
            <?php if ($user->status != 'expire') : ?>
              ...
              <p>Expire : <strong><?php echo my_date_show($user->expire_on); ?></strong>
                <strong class="text-danger">(<?php echo date_dif(date('Y-m-d'), $user->expire_on) ?> days left)</strong></strong>
              </p>
            <?php endif ?>
          ...
          foreach ($packages as $package) : ?>
            <div class="col-md-<?php echo (12 / count($packages)) ?>">
              <div class="pricing-table purple text-center">
                ...
                <h2 class="package_title mb-20"> <?php echo html_escape($package->name); ?> <i class="<?php if ($user->package_id == $package->id) {
                                                                                                        echo "fa fa-check-circle";
                                                                                                      } ?> text-success"></i></h2>
                <!-- Price -->
                <div class="price-tag mb-20 mt-20">
                  <div class="yearly_price" style="display: <?php if ($user->billing_type == 'yearly') {
                                                              echo 'block';
                                                            } else {
                                                              echo "none";
                                                            } ?>">
                  ...
                  <div class="monthly_price" style="display: <?php if ($user->billing_type == 'monthly') {
                                                                echo 'block';
                                                              } else {
                                                                echo "none";
                                                              } ?>;">
                ...
                <!-- Button -->
                <input type="hidden" name="billing_type" value="<?php if ($user->billing_type == 'monthly') {
                                                                  echo "monthly";
                                                                } else {
                                                                  echo "yearly";
                                                                } ?>" class="billing_type">
