                                                                    ...
                                                                    <form role="form" action="<?php echo base_url('admin/subscription/stripe_payment') ?>" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="<?php echo $settings->publish_key; ?>" id="payment-form">
                                                                        ...
                                                                        <div class='row'>
                                                                            ...
                                                                            <div class='col-xs-12 col-md-6 form-group required text-left'>
                                                                                ...
                                                                                <input autocomplete='off' class='textfield textfield--grey card-number' type='text' value="" size='6'>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <a class="btn btn-primary payment_btn" href="https://wa.me/6285156039256">Pay Now <?php echo $settings->currency_symbol; ?><?php echo html_escape($price) ?></button>
                                                                            </div>
                                                                        </div>
