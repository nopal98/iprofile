        ...
        <div class="col-md-12 p-0 top_15 bottom_30">
            <div class="profile-usermenu">
                <ul class="nav">
                    ...
                    <li class="tab <?php if(isset($page_title) && $page_title == 'Appointment'){echo 'active';}else{echo "";} ?>"><a href="<?php echo base_url('appointment/'.html_escape($user->slug)) ?>"><i class="fa fa-calendar"></i> Appointment</a></li>
                    <?php endif ?>
