        ...
        <div id="blog-post">
            <div class="row">
                ...
                <div class="col-md-8 post">
                    ...
                    <div class="tags top_30">
                        ...
                        <?php foreach ($tags as $tag): ?>
                            <a class="btn btn-sm" href="#"># <?php echo html_escape($tag->tag) ?></a>
                        <?php endforeach ?>
                    </div>
                    ...
                    <div class="leave-comment">
                        ...
                        <form method="post" class="site-form mt-15" action="<?php echo base_url('profile/send_comment/'.html_escape($post->id)); ?>">
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-15 bottom_30">
                ...
                <div class="col-md-4 blog-sidebar">
                    ...
                    <div class="category bottom_30 mt-15">
                    ...
                    <div class="tags-list top_30 mt-15">
