...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 13, 2021 at 06:31 AM
...
CREATE TABLE `settings` (
  ...
  `enable_country` int(11) DEFAULT 1,
...
INSERT INTO `settings` (`id`, `site_name`, `site_title`, `favicon`, `logo`, `keywords`, `description`, `footer_about`, `admin_email`, `mobile`, `copyright`, `pagination_limit`, `facebook`, `instagram`, `twitter`, `linkedin`, `google_analytics`, `site_color`, `site_font`, `layout`, `terms_condition`, `about_info`, `ind_code`, `purchase_code`, `enable_captcha`, `enable_registration`, `enable_paypal`, `enable_blog`, `enable_faq`, `enable_country`, `captcha_site_key`, `captcha_secret_key`, `paypal_email`, `paypal_mode`, `paypal_payment`, `stripe_payment`, `publish_key`, `secret_key`, `mail_protocol`, `mail_title`, `mail_host`, `mail_port`, `mail_username`, `mail_password`, `enable_email_verify`, `country`, `version`) VALUES
(1, 'Profile.me', 'Multiuser resume & profile', 'assets/images/logo.png', 'assets/images/logo.png', 'resume,cv,vcard', 'Multiuser resume & profile', 'Freelancers ', 'admin@gmail.com', '', '© 2020 All rights reserved.', 0, 'https://www.facebook.com/', 'facebook.com', '', 'linkedin', '', '', '', 0, '', 'SW52YWxpZCBMaWNlbnNlIEtleQ==', '', '', 0, 1, 0, 1, 1, 1, '', '', 'paypal@gmail.com', 'sandbox', 1, 0, '', '', 'smtp', 'SMTP Mail', 'smtp.gmail.com', '465', '', '', 0, 178, 'v2.0');
...
CREATE TABLE `users` (
  ...
  `gd_color1` varchar(255) DEFAULT '0072ff',
  `gd_color2` varchar(255) DEFAULT '00d4ff',
  ...
  `enable_experience` int(11) DEFAULT 1,
  `enable_skill` int(11) DEFAULT 1,
  `enable_testimonial` int(11) DEFAULT 1,
  `enable_contact` int(11) DEFAULT 1,
  `enable_vcard` int(11) DEFAULT 1,
