...
if (isset($_POST["btn_purchase_code"])) {
    ...
    $_SESSION["purchase_code"] = 'babiato.co';
    $response = "";
    ...
    if (true) {
        ...
        $_SESSION["license_code"] = "babiato.co";
                                    ...
                                    <div class="tab-content">
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="purchase_code" class="form-control form-input" style="resize: vertical; height: 80px;line-height: 24px;padding: 10px;" placeholder="Enter Purchase Code" required>babiato.co</textarea>
                                            </div>
